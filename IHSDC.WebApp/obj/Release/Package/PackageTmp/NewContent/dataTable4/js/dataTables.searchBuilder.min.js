! function (e) {
    ...
    "use strict";
    var I, u, a, d, c, h, p, m, e, i, r = s.fn.dataTable;
    ...
    function w(t, i, e, n, s, r) {
        void 0 === n && (n = 0), void 0 === s && (s = 1), void 0 === r && (r = V);
        var o = this;
        if (!u || !u.versionCheck || !u.versionCheck("1.10.0")) throw new Error("SearchPane requires DataTables 1.10 or newer");
        this.classes = I.extend(!0, {}, w.classes), this.c = I.extend(!0, {}, w.defaults, I.fn.dataTable.ext.searchBuilder, i);
        i = this.c.i18n;
        if (this.s = {
            condition: V,
            conditions: {},
            ...
            for (var a = 0, d = this.dom.value; a < d.length; a++) d[a].addClass(this.classes.greyscale)
        }
        return I(l).on("resize.dtsb", u.util.throttle(function () {
            o.s.topGroup.trigger("dtsb-redrawLogic")
        })), this._buildCriteria(), this
    }

    function g(t, i, e, n, s, r, o) {
        if (void 0 === n && (n = 0), void 0 === s && (s = !1), void 0 === r && (r = 1), void 0 === o && (o = V), d && d.versionCheck && d.versionCheck("1.10.0")) return this.classes = a.extend(!0, {}, g.classes), this.c = a.extend(!0, {}, g.defaults, i), this.s = {
            criteria: [],
            depth: r,
            dt: t,
            index: n,
    ...
    function n(t, i) {
        var s = this;
        if (!p || !p.versionCheck || !p.versionCheck("1.10.0")) throw new Error("SearchBuilder requires DataTables 1.10 or newer");
        t = new p.Api(t);
        if (this.classes = h.extend(!0, {}, n.classes), this.c = h.extend(!0, {}, n.defaults, i), this.dom = {
            ...
            serverData: V,
            topGroup: V
        }, t.settings()[0]._searchBuilder === V) return (t.settings()[0]._searchBuilder = this).s.dt.page.info().serverSide && (this.s.dt.on("preXhr.dtsb", function (t, i, e) {
    ...
    function v(t, i) {
        t = new r.Api(t), i = i || t.init().searchBuilder || r.defaults.searchBuilder;
    ...
    return w._escapeHTML = function (t) {
        ...
        void 0 === t && (t = !1), this.dom.container.children().detach(), this.dom.container.append(this.dom.data).append(this.dom.condition).append(this.dom.inputCont), this.setListeners(), this.dom.value[0] !== V && this.dom.value[0].trigger("dtsb-inserted");
        for (var i = 1; i < this.dom.value.length; i++) this.dom.inputCont.append(this.dom.value[i]), this.dom.value[i].trigger("dtsb-inserted");
        1 < this.s.depth && this.dom.buttons.append(this.dom.left), (!1 === this.c.depthLimit || this.s.depth < this.c.depthLimit) && t ? this.dom.buttons.append(this.dom.right) : this.dom.right.remove(), this.dom.buttons.append(this.dom.delete), this.dom.container.append(this.dom.buttons)
        ...
        if (this.s.condition !== V && e !== V) {
            ...
            if (this.s.type.includes("num") && ("" !== this.s.dt.settings()[0].oLanguage.sDecimal || "" !== this.s.dt.settings()[0].oLanguage.sThousands)) {
                ...
                if ("" !== this.s.dt.settings()[0].oLanguage.sDecimal && (s = t[this.s.dataIdx].split(this.s.dt.settings()[0].oLanguage.sDecimal)), "" !== this.s.dt.settings()[0].oLanguage.sThousands)
                    for (var r = 0; r < s.length; r++) s[r] = s[r].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
                n = s.join(".")
            }
            ...
            } else null !== n && "string" == typeof n && (n = n.replace(/[\r\n\u2028]/g, " "));
        ...
        if (void 0 === t && (t = !1), null === this.s.type || !this.s.type.includes("num") || "" === this.s.dt.settings()[0].oLanguage.sDecimal && "" === this.s.dt.settings()[0].oLanguage.sThousands) {
            if (null !== this.s.type && t)
                if (this.s.type.includes("date") || this.s.type.includes("time"))
                    for (i = 0; i < this.s.value.length; i++) null === this.s.value[i].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) && (this.s.value[i] = "");
                else if (this.s.type.includes("moment"))
                    for (i = 0; i < this.s.value.length; i++) this.s.value[i] && 0 < this.s.value[i].length && o()(this.s.value[i], this.s.dateFormat, !0).isValid() && (this.s.value[i] = o()(this.s.value[i], this.s.dateFormat).format("YYYY-MM-DD HH:mm:ss"));
                else if (this.s.type.includes("luxon"))
                    for (i = 0; i < this.s.value.length; i++) this.s.value[i] && 0 < this.s.value[i].length && null === f().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).invalid && (this.s.value[i] = f().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"))
        } else
            for (var i = 0; i < this.s.value.length; i++) {
                ...
                if ("" !== this.s.dt.settings()[0].oLanguage.sDecimal && (e = this.s.value[i].split(this.s.dt.settings()[0].oLanguage.sDecimal)), "" !== this.s.dt.settings()[0].oLanguage.sThousands)
                    for (var n = 0; n < e.length; n++) e[n] = e[n].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
        ...
        this._populateData(), -1 !== this.s.dataIdx && (this._populateCondition(), this.s.condition !== V) && this._populateValue()
        ...
        if (this._populateData(), t.data !== V && (e = this.classes.italic, n = this.dom.data, this.dom.data.children("option").each(function () {
            !s && (I(this).text() === t.data || t.origData && I(this).prop("origData") === t.origData) ? (I(this).prop("selected", !0), n.removeClass(e), s = !0, i = I(this).val()) : I(this).removeProp("selected")
        })), s) {
            this.s.data = t.data, this.s.origData = t.origData, this.s.dataIdx = i, this.c.orthogonal = this._getOptions().orthogonal, this.dom.dataTitle.remove(), this._populateCondition(), this.dom.conditionTitle.remove();
            ...
            if (this.s.condition = r, this.s.condition !== V) {
                this.dom.conditionTitle.removeProp("selected"), this.dom.conditionTitle.remove(), this.dom.condition.removeClass(this.classes.italic);
                for (a = 0; a < o.length; a++)(d = I(o[a])).val() !== this.s.condition && d.removeProp("selected");
        ...
        this.dom.data.unbind("change").on("change.dtsb", function () {
            ...
            for (var t = l.dom.data.children("option." + l.classes.option), i = 0; i < t.length; i++) {
                var e = I(t[i]);
                e.val() === l.dom.data.val() ? (l.dom.data.removeClass(l.classes.italic), e.prop("selected", !0), l.s.dataIdx = +e.val(), l.s.data = e.text(), l.s.origData = e.prop("origData"), l.c.orthogonal = l._getOptions().orthogonal, l._clearCondition(), l._clearValue(), l._populateCondition(), l.s.filled && (l.s.filled = !1, l.s.dt.draw(), l.setListeners()), l.s.dt.state.save()) : e.removeProp("selected")
            }
            ...
            for (var t = l.dom.condition.children("option." + l.classes.option), i = 0; i < t.length; i++) {
                ...
                if (e.val() === l.dom.condition.val()) {
                    ...
                    for (var o = 0, a = l.dom.value; o < a.length; o++) {
                        var d = a[o];
                        l.s.filled && d !== V && 0 !== l.dom.inputCont.has(d[0]).length && (l.s.filled = !1, l.s.dt.draw(), l.setListeners())
                    } (0 === l.dom.value.length || 1 === l.dom.value.length && l.dom.value[0] === V) && l.s.dt.draw()
                } else e.removeProp("selected")
            }
        })
    }, w.prototype.setupButtons = function () {
        550 < l.innerWidth ? (this.dom.container.removeClass(this.classes.vertical), this.dom.buttons.css("left", null), this.dom.buttons.css("top", null)) : (this.dom.container.addClass(this.classes.vertical), this.dom.buttons.css("left", this.dom.data.innerWidth()), this.dom.buttons.css("top", this.dom.data.position().top))
        ...
        this.dom.condition.empty(), this.dom.conditionTitle.prop("selected", !0).attr("disabled", "true"), this.dom.condition.prepend(this.dom.conditionTitle).prop("selectedIndex", 0), this.s.conditions = {}, this.s.condition = V
    }, w.prototype._clearValue = function () {
        if (this.s.condition !== V) {
            if (0 < this.dom.value.length && this.dom.value[0] !== V)
                for (var t = 0, i = this.dom.value; t < i.length; t++) ! function (t) {
            ...
            if (this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, w.updateListener)), 0 < this.dom.value.length && this.dom.value[0] !== V) {
                this.dom.inputCont.empty().append(this.dom.value[0]).insertAfter(this.dom.condition), this.dom.value[0].trigger("dtsb-inserted");
                for (var e = 1; e < this.dom.value.length; e++) this.dom.inputCont.append(this.dom.value[e]), this.dom.value[e].trigger("dtsb-inserted")
            }
        } else {
            for (var n = 0, s = this.dom.value; n < s.length; n++) ! function (t) {
                t !== V && setTimeout(function () {
                    t.remove()
                }, 50)
            }(s[n]);
        ...
        this.s.value = [], this.dom.value = [I("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select).append(this.dom.valueTitle.clone())]
        ...
        if (0 === i) {
            this.s.type = this.s.dt.columns().type().toArray()[n], e !== V && ((s = e[n]).searchBuilderType !== V && null !== s.searchBuilderType ? this.s.type = s.searchBuilderType : this.s.type !== V && null !== this.s.type || (this.s.type = s.sType)), null !== this.s.type && this.s.type !== V || (I.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]), this.s.type = this.s.dt.columns().type().toArray()[n]), this.dom.condition.removeAttr("disabled").empty().append(this.dom.conditionTitle).addClass(this.classes.italic), this.dom.conditionTitle.prop("selected", !0);
            ...
            for (var l = 0, u = Object.keys(this.s.conditions); l < u.length; l++) {
                ...
                this.s.condition !== V && this.s.condition === y && (h.prop("selected", !0), this.dom.condition.removeClass(this.classes.italic)), t.push(h)
            }
        }
        ...
        if (e[n].searchBuilder && e[n].searchBuilder.defaultCondition) {
            ...
            if ("number" == typeof f) this.dom.condition.prop("selectedIndex", f), this.dom.condition.trigger("change");
                ...
                for (var g = 0; g < t.length; g++)
                    for (var v = 0, b = Object.keys(this.s.conditions); v < b.length; v++) {
                        ...
                        if (("string" == typeof (y = this.s.conditions[C].conditionName) ? y : y(this.s.dt, this.c.i18n)) === t[g].text() && C === f) {
                            this.dom.condition.prop("selectedIndex", this.dom.condition.children().toArray().indexOf(t[g][0])).removeClass(this.classes.italic), this.dom.condition.trigger("change"), g = t.length;
                            break
                        }
                    }
        ...
        for (var e, n, s = 0; s < t.length; s++) !0 !== this.c.columns && !i.includes(s) || (n = {
            index: s,
            origData: (e = t[s]).data,
        ...
        }, 50), 0), s = this.dom.value; n < s.length; n++) ! function (t) {
            setTimeout(function () {
                t !== V && t.remove()
            }, 50)
        }(s[n]);
        ...
        }), this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, w.updateListener, i !== V ? i.value : V)), i !== V && i.value !== V && (this.s.value = i.value), this.dom.inputCont.empty(), this.dom.value[0] !== V && this.dom.value[0].appendTo(this.dom.inputCont).trigger("dtsb-inserted");
        for (o = 1; o < this.dom.value.length; o++) this.dom.value[o].insertAfter(this.dom.value[o - 1]).trigger("dtsb-inserted");
        this.s.filled = this.s.conditions[this.s.condition].isInputValid(this.dom.value, this), this.setListeners(), this.s.preventRedraw || t === this.s.filled || (this.s.dt.page.info().serverSide || this.s.dt.draw(), this.setListeners())
        ...
        return null === (s = void 0 === s ? 200 : s) && (s = 200),
            function () {
                ...
                var e = +new Date;
                null !== r && e < r + s ? clearTimeout(o) : r = e, o = setTimeout(function () {
                    r = null, n.apply(a, t)
                }, s)
            }
            ...
            var h = c[u],
                ...
                f = ("array" === e.s.type && (m.filter = Array.isArray(m.filter) ? m.filter : [m.filter], m.text = Array.isArray(m.text) ? m.text : [m.text]), function (t, i) {
                    ...
                    t = I("<option>", {
                        ...
                        value: t
                    }).data("sbv", t).addClass(e.classes.option).addClass(e.classes.notItalic).html("string" == typeof i ? i.replace(/(<([^>]+)>)/gi, "") : i), i = t.val(); - 1 === d.indexOf(i) && (d.push(i), l.push(t), null !== n && Array.isArray(n[0]) && (n[0] = n[0].sort().join(",")), null !== n) && t.val() === n[0] && (t.prop("selected", !0), a.removeClass(w.classes.italic), e.dom.valueTitle.removeProp("selected"))
                });
            if (i)
        ...
        for (var n = I("<select/>").addClass(w.classes.value).addClass(w.classes.dropDown).addClass(w.classes.italic).addClass(w.classes.select).append(t.dom.valueTitle).on("change.dtsb", function () {
            ...
            var a = o[r],
                d = a.value,
                a = a.label;
            t.s.type.includes("html") && null !== d && "string" == typeof d && d.replace(/(<([^>]+)>)/gi, ""), d = I("<option>", {
                type: Array.isArray(d) ? "Array" : "String",
                value: d
            }).data("sbv", d).addClass(t.classes.option).addClass(t.classes.notItalic).html("string" == typeof a ? a.replace(/(<([^>]+)>)/gi, "") : a), s.push(d), null !== e && d.val() === e[0] && (d.prop("selected", !0), n.removeClass(w.classes.italic), t.dom.valueTitle.removeProp("selected"))
        }
            ...
            for (var s = 0; s < t.s.value.length; s++)
                if (Array.isArray(t.s.value[s])) t.s.value[s].sort();
                    ...
                    if ("" !== t.s.dt.settings()[0].oLanguage.sDecimal && (r = t.s.value[s].split(t.s.dt.settings()[0].oLanguage.sDecimal)), "" !== t.s.dt.settings()[0].oLanguage.sThousands)
                        for (var o = 0; o < r.length; o++) r[o] = r[o].replace(t.s.dt.settings()[0].oLanguage.sThousands, ",");
                    t.s.value[s] = r.join(".")
                }
            for (var a = null, d = null, s = 0; s < t.dom.value.length; s++) i === t.dom.value[s][0] && (a = s, i.selectionStart !== V) && (d = i.selectionStart);
            (t.c.enterSearch || t.s.dt.settings()[0].oInit.search !== V && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.s.dt.draw(), null !== a && (t.dom.value[a].removeClass(t.classes.italic), t.dom.value[a].focus(), null !== d) && t.dom.value[a][0].setSelectionRange(d, d)
        } else (t.c.enterSearch || t.s.dt.settings()[0].oInit.search !== V && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.s.dt.draw()
    }, w.dateConditions = {
        "=": {
        ...
        preDefined: !1
    }, c = w, g.prototype.destroy = function () {
        this.dom.add.off(".dtsb"), this.dom.logic.off(".dtsb"), this.dom.container.trigger("dtsb-destroy").remove(), this.s.criteria = []
        ...
        if (!(t.criteria === V || null === t.criteria || Array.isArray(t.criteria) && 0 === t.criteria.length)) {
            if (this.s.logic = t.logic, this.dom.logic.children().first().html("OR" === this.s.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)), Array.isArray(t.criteria))
                for (var i = 0, e = t.criteria; i < e.length; i++)(n = e[i]).logic !== V ? this._addPrevGroup(n) : n.logic === V && this._addPrevCriteria(n);
            for (var n, s = 0, r = this.s.criteria; s < r.length; s++)(n = r[s]).criteria instanceof c && (n.criteria.updateArrows(1 < this.s.criteria.length), this._setCriteriaListeners(n.criteria))
        }
    }, g.prototype.redrawContents = function () {
        if (!this.s.preventRedraw) {
            this.dom.container.children().detach(), this.dom.container.append(this.dom.logicContainer).append(this.dom.add), this.s.criteria.sort(function (t, i) {
        ...
        if (this.dom.logicContainer.remove(), this.dom.clear.remove(), this.s.criteria.length < 1) this.s.isChild || (this.dom.container.trigger("dtsb-destroy"), this.dom.container.css("margin-left", 0));
        else {
            this.dom.clear.height("0px"), this.dom.logicContainer.append(this.dom.clear), this.dom.container.prepend(this.dom.logicContainer);
            for (var t = 0, i = this.s.criteria; t < i.length; t++) {
                var e = i[t];
        ...
        for (var i = null === (t = void 0 === t ? null : t) ? this.s.criteria.length : t.s.index, e = new c(this.s.dt, this.s.opts, this.s.topGroup, i, this.s.depth, this.s.serverData), n = (null !== t && (e.c = t.c, e.s = t.s, e.s.depth = this.s.depth, e.classes = t.classes), e.populate(), !1), s = 0; s < this.s.criteria.length; s++) 0 === s && this.s.criteria[s].criteria.s.index > e.s.index ? (e.getNode().insertBefore(this.s.criteria[s].criteria.dom.container), n = !0) : s < this.s.criteria.length - 1 && this.s.criteria[s].criteria.s.index < e.s.index && this.s.criteria[s + 1].criteria.s.index > e.s.index && (e.getNode().insertAfter(this.s.criteria[s].criteria.dom.container), n = !0);
        n || e.getNode().insertBefore(this.dom.add), this.s.criteria.push({
            criteria: e,
            index: i
        ...
        for (var r = 0, o = this.s.criteria; r < o.length; r++) {
            var a = o[r];
            a.criteria instanceof c && a.criteria.updateArrows(1 < this.s.criteria.length)
        }
        this._setCriteriaListeners(e), e.setListeners(), this.setupLogic()
    }, g.prototype.checkFilled = function () {
        for (var t = 0, i = this.s.criteria; t < i.length; t++) {
            var e = i[t];
            if (e.criteria instanceof c && e.criteria.s.filled || e.criteria instanceof g && e.criteria.checkFilled()) return !0
        }
        return !1
        ...
        this.s.criteria.push({
            ...
            index: i,
            logic: e.s.logic
        }), e.rebuild(t), this.s.criteria[i].criteria = e, this.s.topGroup.trigger("dtsb-redrawContents"), this._setGroupListeners(e)
    }, g.prototype._addPrevCriteria = function (t) {
        var i = this.s.criteria.length,
            e = new c(this.s.dt, this.s.opts, this.s.topGroup, i, this.s.depth, this.s.serverData);
        e.populate(), this.s.criteria.push({
            criteria: e,
            index: i
        }), e.s.preventRedraw = this.s.preventRedraw, e.rebuild(t), e.s.preventRedraw = !1, this.s.criteria[i].criteria = e, this.s.preventRedraw || this.s.topGroup.trigger("dtsb-redrawContents")
    }, g.prototype._andSearch = function (t, i) {
        if (0 !== this.s.criteria.length)
            for (var e = 0, n = this.s.criteria; e < n.length; e++) {
                var s = n[e];
                if ((!(s.criteria instanceof c) || s.criteria.s.filled) && !s.criteria.search(t, i)) return !1
            }
        return !0
        ...
        for (var e = !1, n = 0, s = this.s.criteria; n < s.length; n++) {
            ...
            } else if (r.criteria instanceof g && r.criteria.checkFilled() && (e = !0, r.criteria.search(t, i))) return !0
        }
        return !e
    }, g.prototype._removeCriteria = function (t, i) {
        if (void 0 === i && (i = !1), this.s.criteria.length <= 1 && this.s.isChild) this.destroy();
        else {
            for (var e = void 0, n = 0; n < this.s.criteria.length; n++) this.s.criteria[n].index === t.s.index && (!i || this.s.criteria[n].criteria instanceof g) && (e = n);
            e !== V && this.s.criteria.splice(e, 1);
            for (n = 0; n < this.s.criteria.length; n++) this.s.criteria[n].index = n, this.s.criteria[n].criteria.s.index = n
        }
        ...
        n.dom.delete.unbind("click").on("click.dtsb", function () {
            ...
            for (var t = 0, i = s.s.criteria; t < i.length; t++) {
                var e = i[t];
                e.criteria instanceof c && e.criteria.updateArrows(1 < s.s.criteria.length)
            }
            ...
            s.s.toDrop = new c(s.s.dt, s.s.opts, s.s.topGroup, n.s.index, V, s.s.serverData), s.s.toDrop.s = n.s, s.s.toDrop.c = n.c, s.s.toDrop.classes = n.classes, s.s.toDrop.populate();
        ...
        for (var e = this, n = (t.criteria !== V && t.logic === V && (t.logic = "AND"), this), i = 0, s = t.criteria; i < s.length; i++) ! function (i) {
        ...
        if (void 0 === t && (t = !0), h.fn.DataTable.Api.registerPlural("columns().type()", "column().type()", function () {
            ...
            for (var a = 0; a < o[0].length; a++) {
                var d = i[o[0][a]];
                if ((!0 === this.c.columns || Array.isArray(this.c.columns) && this.c.columns.includes(a)) && (d.includes("date") || d.includes("moment") || d.includes("luxon"))) throw alert("SearchBuilder Requires DateTime when used with dates."), new Error("SearchBuilder requires DateTime")
            }
        }
        this.s.topGroup = new m(this.s.dt, this.c, V, V, V, V, this.s.serverData), this._setClearListener(), this.s.dt.on("stateSaveParams.dtsb", function (t, i, e) {
        ...
        }), this._build(), this.s.dt.on("preXhr.dtsb", function (t, i, e) {
            n.s.dt.page.info().serverSide && (e.searchBuilder = n._collapseArray(n.getDetails(!0)))
        }), this.s.dt.on("column-reorder", function () {
            n.rebuild(n.getDetails())
        }), t && (null !== (t = this.s.dt.state.loaded()) && t.searchBuilder !== V ? (this.s.topGroup.rebuild(t.searchBuilder), this.s.topGroup.dom.container.trigger("dtsb-redrawContents"), this.s.dt.page.info().serverSide || (t.page ? this.s.dt.page(t.page).draw("page") : this.s.dt.scroller && t.scroller && this.s.dt.scroller().scrollToRow(t.scroller.topRow)), this.s.topGroup.setListeners()) : !1 !== this.c.preDefined && (this.c.preDefined = this._applyPreDefDefaults(this.c.preDefined), this.rebuild(this.c.preDefined))), this._setEmptyListener(), this.s.dt.state.save()
    }, n.prototype._collapseArray = function (t) {
        if (t.logic === V) t.value !== V && (t.value.sort(function (t, i) {
            return isNaN(+t) || (t = +t, i = +i), t < i ? -1 : i < t ? 1 : 0
        }), t.value1 = t.value[0], t.value2 = t.value[1]);
        else
            for (var i = 0; i < t.criteria.length; i++) t.criteria[i] = this._collapseArray(t.criteria[i]);
        return t
        ...
        }, h.fn.dataTable.ext.search.push(this.s.search)), this.s.dt.on("destroy.dtsb", function () {
            n.dom.container.remove(), n.dom.clearAll.remove();
            for (var t = h.fn.dataTable.ext.search.indexOf(n.s.search); - 1 !== t;) h.fn.dataTable.ext.search.splice(t, 1), t = h.fn.dataTable.ext.search.indexOf(n.s.search);
        ...
        var t = this;
        this.dom.clearAll.unbind("click"), this.dom.clearAll.on("click.dtsb", function () {
        ...
        this.s.topGroup.dom.container.unbind("dtsb-redrawContents"), this.s.topGroup.dom.container.on("dtsb-redrawContents.dtsb", function () {
            ...
            i._checkClear(), i.s.topGroup.s.preventRedraw = !0, i.s.topGroup.redrawContents(), i.s.topGroup.s.preventRedraw = !1, i.s.topGroup.setupLogic(), i._setEmptyListener();
            var t = i.s.topGroup.count();
    ...
    }, n.version = "1.5.0", n.classes = {
        button: "dtsb-button",
        clearAll: "dtsb-clearAll",
        container: "dtsb-searchBuilder d-none",
        inputButton: "dtsb-iptbtn",
        title: "dtsb-title",
        ...
        preDefined: !1
    }, e = n, p = (h = s).fn.DataTable, d = (a = s).fn.dataTable, u = (I = s).fn.dataTable, i = s.fn.dataTable, r.SearchBuilder = e, i.SearchBuilder = e, r.Group = m, i.Group = m, r.Criteria = c, i.Criteria = c, i = r.Api.register, r.ext.searchBuilder = {
        conditions: {}
        ...
        action: function (t, i, e, n) {
            ...
            n !== V && n.dom.container.trigger("dtsb-redrawContents-noDraw"), 0 === n.s.criteria.length && s("." + s.fn.dataTable.Group.classes.add.replace(/ /g, ".")).click()
        },
        config: {},
        init: function (e, n, t) {
